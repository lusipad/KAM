...
- GitHub Issues：issue monitor 会把新建或更新的 issue 写进任务池，并带上 issue 标题、正文和评论上下文
...
- `menu` 适合人值守时快速选择推荐动作
- `monitor-github-issues.ps1` 适合把 GitHub issue 自动送进 KAM 任务池
- `watch` 适合盯盘，不适合交互恢复
